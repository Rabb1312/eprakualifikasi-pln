    ...
    <div class="forgot-bg">
        ...
        <div class="forgot-container">
            <div class="forgot-header">
                ...
                <h2>Lupa Password</h2>
                <p>
                    Masukkan alamat email Anda untuk menerima link reset
                    password
                </p>
            </div>
            ...
            <div v-else class="success-message">
                ...
                <p>
                    Kami telah mengirim link reset password ke alamat email
                    <strong>{{ email }}</strong
    ...
    try {
        ...
        if (error.response) {
            ...
            if (error.response.status === 422) {
                showAlert(
                    "error",
                    "Email tidak valid atau tidak terdaftar dalam sistem"
                );
                ...
                showAlert(
                    "error",
                    errorData.message || "Terjadi kesalahan saat mengirim email"
                );
            }
        } else {
            showAlert(
