            ...
            <div class="content-sections">
                ...
                <div class="categories-summary">
                    ...
                    <div class="categories-grid">
                        <div 
                            v-for="(category, index) in getStaffCategories()"
                            :key="index"
                            class="category-item"
                        >
                            <div class="category-icon">
                                <i :class="getCertificationIcon(category.name)"></i>
                            </div>
                            <div class="category-info">
                                <h6>{{ category.name }}</h6>
                                <span class="category-count">{{ category.count }} staff</span>
                                <div class="category-breakdown">
                                    <span class="breakdown-item">FT: {{ category.fullTime }}</span>
                                    <span class="breakdown-item">PT: {{ category.partTime }}</span>
                                </div>
                            </div>
                ...
                <div class="manpower-statistics">
                    ...
                    <div class="statistics-grid">
                        ...
                        <div class="statistic-item">
                            ...
                            <div class="statistic-info">
                                <span class="statistic-number">{{ getTotalFullTime() }}</span>
                                <span class="statistic-label">Full Time Staff</span>
                            </div>
                        </div>
                        <div class="statistic-item">
                            <div class="statistic-icon">
                            ...
                            <div class="statistic-info">
                                <span class="statistic-number">{{ getTotalPartTime() }}</span>
                                <span class="statistic-label">Part Time Staff</span>
                            </div>
                        </div>
                        <div class="statistic-item">
                            <div class="statistic-icon">
                            ...
                            <div class="statistic-info">
                                <span class="statistic-number">{{ getCertifiedStaffCount() }}</span>
                                <span class="statistic-label">Certified Staff</span>
                            </div>
                        </div>
                    </div>
                </div>
