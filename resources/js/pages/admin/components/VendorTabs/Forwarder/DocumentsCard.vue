    ...
    <div class="documents-card">
        <div class="section-header">
            ...
            <div class="header-info">
                ...
                <p>Dokumen dan lampiran yang diperlukan untuk forwarder</p>
            </div>
        ...
        <div v-else class="no-data">
            <div class="no-data-illustration">
                ...
                <p>Dokumen dan lampiran belum diupload untuk forwarder ini</p>
            </div>
        </div>
    </div>
</template>
...
const documentsList = computed(() => {
    ...
    // Return mock documents for forwarder
    return [
        {
            id: 1,
            ...
            status: 'approved',
            file_name: 'company_registration.pdf',
            file_size: '1024000',
            uploaded_at: '2025-08-20T10:30:00Z',
            file_path: '/documents/company_registration.pdf'
        },
        {
            id: 2,
            document_type: 'freight_forwarding_license',
            document_name: 'Freight Forwarding License',
            status: 'approved',
            file_name: 'ff_license.pdf',
            file_size: '2048000',
            uploaded_at: '2025-08-21T14:15:00Z',
            file_path: '/documents/ff_license.pdf',
            expiry_date: '2026-12-31T23:59:59Z'
        },
        {
            id: 3,
            document_type: 'customs_permit',
            document_name: 'Customs Clearance Permit',
            status: 'pending',
            file_name: 'customs_permit.pdf',
            file_size: '1536000',
            uploaded_at: '2025-08-22T09:45:00Z',
            file_path: '/documents/customs_permit.pdf'
        },
        {
            id: 4,
            ...
            file_path: '/documents/insurance_policy.pdf',
            rejection_reason: 'Policy coverage insufficient for cargo transportation'
        }
    ]
})
