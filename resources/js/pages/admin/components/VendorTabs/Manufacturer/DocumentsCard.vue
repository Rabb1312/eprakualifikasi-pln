    ...
    <div class="documents-card">
        <div class="section-header">
            ...
            <div class="header-info">
                ...
                <p>Dokumen dan lampiran yang diperlukan untuk manufacturer</p>
            </div>
        ...
        <div v-else class="no-data">
            <div class="no-data-illustration">
                ...
                <p>Dokumen dan lampiran belum diupload untuk manufacturer ini</p>
            </div>
        </div>
    </div>
</template>
...
const documentsList = computed(() => {
    ...
    // Return mock documents for manufacturer
    return [
        {
            id: 1,
            document_type: 'manufacturing_license',
            document_name: 'Manufacturing License',
            status: 'approved',
            file_name: 'manufacturing_license.pdf',
            file_size: '2048000',
            uploaded_at: '2025-08-20T10:30:00Z',
            file_path: '/documents/manufacturing_license.pdf',
        ...
        },
        {
            ...
            file_size: '1536000',
            uploaded_at: '2025-08-21T14:15:00Z',
            file_path: '/documents/iso_9001_certificate.pdf',
            expiry_date: '2027-08-20T23:59:59Z'
        },
        {
            id: 3,
            ...
            status: 'pending',
            file_name: 'environmental_assessment.pdf',
            file_size: '3072000',
            uploaded_at: '2025-08-22T09:45:00Z',
            file_path: '/documents/environmental_assessment.pdf'
        },
        {
            id: 4,
            ...
            status: 'rejected',
            file_name: 'safety_certificate.pdf',
            file_size: '1024000',
            uploaded_at: '2025-08-23T16:20:00Z',
            file_path: '/documents/safety_certificate.pdf',
            rejection_reason: 'Certificate has expired and needs renewal'
        },
        {
            id: 5,
            document_type: 'quality_manual',
            document_name: 'Quality Management Manual',
            status: 'approved',
            file_name: 'quality_manual.pdf',
            file_size: '4096000',
            uploaded_at: '2025-08-24T11:30:00Z',
            file_path: '/documents/quality_manual.pdf'
        }
    ]
})
...
const filteredDocuments = computed(() => {
    ...
    return documentsList.value.filter(doc => {
        switch (activeFilter.value) {
            ...
            case 'pending':
                return ['uploaded', 'under_review', 'pending'].includes(doc.status)
            default:
                return true
        }
    })
...
function getFilterCount(filterKey) {
    ...
    if (filterKey === 'pending') return documentsList.value.filter(doc => ['uploaded', 'under_review', 'pending'].includes(doc.status)).length
    return 0
}
...
function getDocumentIcon(doc) {
    ...
    if (type.includes('license')) return 'fas fa-certificate'
    if (type.includes('certification') || type.includes('certificate')) return 'fas fa-award'
    if (type.includes('permit')) return 'fas fa-stamp'
    if (type.includes('manual')) return 'fas fa-book'
...
<style scoped>
/* Menggunakan style yang sama dengan DocumentsCard untuk Forwarder dengan beberapa penyesuaian warna */
.documents-card {
    padding: 24px;
    min-height: 400px;
}
