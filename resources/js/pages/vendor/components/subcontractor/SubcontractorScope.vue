...
<template>
    <div class="subcontractor-scope">
        <div class="tab-header">
            ...
            <p>
                What kind of scope of work does your company usually
                sub-contracted to? Please mention, if any. / Lingkup pekerjaan
                seperti apa yang biasanya di sub-kontrakkan oleh perusahaan
                Anda? Mohon sebutkan, jika ada.
            </p>
        </div>
...
const scopeCategories = [
    {
        ...
        description:
            "Power distribution, transmission lines, substation electrical work",
    },
    {
    ...
    },
    {
        ...
        description:
            "System testing, performance verification, startup services",
    },
    {
        id: "maintenance",
    ...
    },
    {
        ...
        description:
            "Equipment erection, tower installation, structural assembly",
    },
];
...
async function saveScope() {
    if (!formData.scope_of_work.trim()) {
        showAlert(
            "warning",
            "Please provide a description of your scope of work"
        );
        return;
    }
    ...
    if (formData.scope_of_work.length > maxCharacters) {
        showAlert(
            "warning",
            `Scope of work description cannot exceed ${maxCharacters} characters`
        );
        return;
    }
    ...
    try {
        ...
        if (response.data.success) {
            ...
            showAlert(
                "error",
                response.data.message || "Failed to save scope of work"
            );
        }
    } catch (error) {
        ...
        showAlert(
            "error",
            error.response?.data?.message || "Failed to save scope of work"
        );
    } finally {
        loading.value = false;
    }
