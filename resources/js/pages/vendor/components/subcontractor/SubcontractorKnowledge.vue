...
<template>
  <div class="subcontractor-knowledge">
    <div class="tab-header">
      ...
      <p>Does your company aware and knowledgeable about local region regulation, policy, and law? / Apakah Perusahaan Anda memiliki kesadaran dan pengetahuan mengenai hukum, kebijakan dan peraturan daerah setempat?</p>
    </div>
    ...
    <div class="knowledge-section">
        ...
        <div class="radio-group">
          <label class="radio-option">
            ...
            <div class="option-content">
              ...
              <span>Ya, kami memiliki pengetahuan dan kesadaran</span>
            </div>
          </label>
      ...
      <!-- Knowledge Details -->
      <div class="knowledge-details" v-if="formData.local_regulation_knowledge">
        <div class="form-group">
          <label>Please provide details about your knowledge and understanding</label>
          <textarea 
    ...
    <div class="form-actions">
      <button @click="saveKnowledge" :disabled="loading" class="btn btn-primary">
...
function resetForm() {
  if (confirm('Are you sure you want to reset all knowledge assessment data?')) {
...
async function saveKnowledge() {
  if (!formData.local_regulation_knowledge) {
    showAlert('warning', 'Please select your knowledge level regarding local regulations')
    return
  }

  if (formData.local_regulation_knowledge === 'yes' && !formData.regulation_knowledge_details.trim()) {
    showAlert('warning', 'Please provide details about your regulatory knowledge')
    return
  }

  if (formData.local_regulation_knowledge === 'no' && !formData.guidance_needed.trim()) {
    showAlert('warning', 'Please describe the areas where you need guidance')
    return
  }
  ...
  try {
    ...
    if (response.data.success) {
      ...
      showAlert('error', response.data.message || 'Failed to save knowledge assessment')
    }
  } catch (error) {
    console.error('Save knowledge error:', error)
    showAlert('error', error.response?.data?.message || 'Failed to save knowledge assessment')
  } finally {
    loading.value = false
  }
}
