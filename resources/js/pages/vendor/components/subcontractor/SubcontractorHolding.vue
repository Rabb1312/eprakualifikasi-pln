...
const contactPersons = ref([{ nama: "", jabatan: "", telepon: "", email: "" }]);
...
function initializeFormData() {
    ...
    if (
        data.holding_contact_person &&
        Array.isArray(data.holding_contact_person)
    ) {
...
async function saveHolding() {
    ...
    try {
        ...
        if (response.data.success) {
            showAlert(
                "success",
                "Holding company information saved successfully!"
            );
            ...
            showAlert(
                ...
                response.data.message ||
                    "Failed to save holding company information"
            );
        }
    } catch (error) {
