...
<template>
    <div class="subcontractor-facilities">
        <div class="tab-header">
            ...
            <p>
                What facilities which available in your company? / Fasilitas apa
                yang merupakan kapabilitas Perusahaan Anda?
            </p>
        </div>
        ...
        <div class="facilities-section">
            ...
            <p class="section-description">
                Please select all facilities that your company provides (you can
...
async function saveFacilities() {
    ...
    try {
        ...
        if (response.data.success) {
            ...
            showAlert(
                "error",
                response.data.message || "Failed to save facilities information"
            );
        }
    } catch (error) {
        ...
        showAlert(
            ...
            error.response?.data?.message ||
                "Failed to save facilities information"
        );
    } finally {
        loading.value = false;
    }
