<template>
  <div class="distributor-documents">
    <div class="tab-header">
      ...
      <p>
        Document checklist and submission status for distributor qualification / Daftar dokumen dan status pengajuan untuk kualifikasi distributor.
      </p>
    </div>
    ...
    <div v-else class="documents-section">
      <!-- ✅ ADD: Summary Cards seperti SubcontractorDocuments -->
      ...
      <!-- ✅ IMPROVED: Tab System with better styling -->
      <div v-if="Object.keys(attachments).length > 0" class="attachment-tabs">
        ...
        <div class="tab-content">
          <div v-if="attachments[activeTab]" class="attachment-content">
            <!-- ✅ ADD: Table Header dengan Refresh Button -->
            ...
            <div class="table-container">
              <!-- ✅ IMPROVED: Grouped Documents Display -->
                  ...
                  <table class="documents-table">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <!-- ✅ IMPROVED: Files Column dengan Status Indicators -->
                        <td class="file-display">
                            ...
                            <div class="files-list">
                              <div v-for="file in doc.all_files" :key="file.id" class="file-item">
                                <div class="file-info">
                                  ...
                                  <!-- ✅ ADD: Status Dot untuk setiap file -->
                          ...
                          <!-- ✅ IMPROVED: No file state untuk multiple documents -->
                        ...
                        <!-- ✅ IMPROVED: Actions Column dengan Template Download -->
                        <td class="text-center">
                ...
                <table class="documents-table">
                  ...
                  <tbody>
                    <tr v-for="(doc, idx) in attachments[activeTab]?.documents || []" :key="doc.id || idx" :class="getRowClass(doc)">
                      ...
                      <td class="file-display">
                        <!-- Similar file display logic as grouped version -->
                        <div v-if="doc.allows_multiple && doc.all_files?.length" class="multiple-files">
                          <div class="file-count-badge">
                            <i class="fas fa-files"></i>
                            {{ doc.file_count }} file(s)
...
// ✅ Enhanced reactive data seperti SubcontractorDocuments
...
// ✅ Lifecycle
onMounted(async () => {
  console.log("🚀 DistributorDocuments mounted")
  await loadDocuments()
})
...
async function loadDocuments() {
  ...
  // ✅ RESET: Clear upload states when loading
...
function openUploadModal(document) {
  // ✅ RESET: Clear any lingering upload states
  resetAllUploadStates()
...
function closeUploadModal() {
  ...
  // ✅ ADDITIONAL: Reset upload states
...
async function uploadDocumentFiles() {
  ...
  // ✅ FLEXIBLE: Use either id or document_type for identifier
  ...
  try {
    ...
    if (response.data.success) {
      ...
      // ✅ REFRESH: Load documents to show updated data
      await loadDocuments()
    } else {
    ...
    // ✅ CRITICAL: Always reset upload state in finally block
    uploadingDocuments.value[documentIdentifier] = false
    uploadProgress.show = false
    
    // ✅ ADDITIONAL: Force reactivity update
...
async function deleteDocument(document) {
    // Same implementation as SubcontractorDocuments
    try {
